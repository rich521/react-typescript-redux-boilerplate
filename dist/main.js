...
var react_redux_1 = __webpack_require__(37);
var configureStore_1 = __webpack_require__(65);
__webpack_require__(70);
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: configureStore_1.store },
    React.createElement("div", { className: "app_container" },
        React.createElement("h1", null, "React Redux Typescript Starter Pack"))), document.getElementById('app'));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16), __webpack_require__(56)(module)))
...
var redux_thunk_1 = __webpack_require__(66);
var reducer_1 = __webpack_require__(67);
var store = redux_1.createStore(reducer_1.rootReducer, redux_1.applyMiddleware(redux_thunk_1.default));
exports.store = store;
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(7);
var hello_1 = __webpack_require__(68);
...
Object.defineProperty(exports, "__esModule", { value: true });
var rootStore_1 = __webpack_require__(69);
var actionTypes_1 = __webpack_require__(75);
exports.hello = function (state, action) {
    if (state === void 0) { state = rootStore_1.rootState.hello; }
    switch (action.type) {
        case actionTypes_1.ActionTypes.SetName: return __assign({}, state, { name: action.name });
        case actionTypes_1.ActionTypes.SetAge: return __assign({}, state, { age: action.age });
...
(function (ActionTypes) {
    ActionTypes["SetName"] = "SET_NAME";
    ActionTypes["SetAge"] = "SET_AGE";
